    ...
    <div className={`relative inline-block w-full max-w-sm sm:max-w-md lg:max-w-xl select-text mt-2 sm:mt-4 ${className}`}>
      ...
      <div className="animate-cloud-float">
        <div className="relative flex items-center justify-center">
          ...
          <div
            className="absolute -inset-x-10 -top-7 -bottom-6 sm:-inset-x-14 sm:-top-10 sm:-bottom-8 lg:-inset-x-16 lg:-top-12 lg:-bottom-10 pointer-events-none"
            style={{
              filter:
          ...
          >
            <Image
              src="/img/fluffy_cloud_vector.webp"
